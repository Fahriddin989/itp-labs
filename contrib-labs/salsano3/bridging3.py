...
def myNetwork():
    ...
    Link(s1, h4, intfName1='s1-eth3')
    Link(s1, s2, intfName1='s1-eth4', intfName2='s2-eth0')
    Link(s2, h5, intfName1='s2-eth1')
    ...
    s1.cmd('ip link set s1-eth4 master br0')
